...
export function FocusKPICards({ metrics }: FocusKPICardsProps) {
  const riskConfig = {
    ...
    at_risk: { label: "Needs attention", color: "text-amber-600", dotColor: "bg-amber-500" },
    critical: { label: "Blocked", color: "text-red-600", dotColor: "bg-red-500" },
  }
  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-5">
        <p className="text-xs text-neutral-500 mb-2">Close status</p>
